...
namespace AudioCuesheetEditor.Model.AudioCuesheet.Tests
{
    ...
    public class CuesheetTests
    {
        ...
        public void TrackOverlappingTest()
        {
            ...
            //TODO
            //Assert.IsTrue(validationResult.ValidationMessages?.Contains(String.Format("{0} {1} '{2}' is used also by {3}({4},{5},{6},{7},{8}). Positions must be unique!", nameof(Track), nameof(Track.Position), track1.Position, nameof(Track), track1.Position, track1.Artist, track1.Title, track1.Begin, track1.End)));
            //Assert.IsTrue(validationResult.ValidationMessages?.Contains(String.Format("{0} {1} '{2}' is used also by {3}({4},{5},{6},{7},{8}). Positions must be unique!", nameof(Track), nameof(Track.Position), track2.Position, nameof(Track), track2.Position, track2.Artist, track2.Title, track2.Begin, track2.End)));
            //Assert.IsTrue(validationResult.ValidationMessages?.Contains(String.Format("{0} {1} '{2}' is used also by {3}({4},{5},{6},{7},{8}). Positions must be unique!", nameof(Track), nameof(Track.Position), track3.Position, nameof(Track), track3.Position, track3.Artist, track3.Title, track3.Begin, track3.End)));
            //Assert.IsTrue(validationResult.ValidationMessages?.Contains(String.Format("{0}({1},{2},{3},{4},{5}) is overlapping with {0}({6},{7},{8},{9},{10}). Please make shure the timeinterval is only used once!", nameof(Track), track1.Position, track1.Artist, track1.Title, track1.Begin, track1.End, track2.Position, track2.Artist, track2.Title, track2.Begin, track2.End)));
            //Assert.IsTrue(validationResult.ValidationMessages?.Contains(String.Format("{0}({1},{2},{3},{4},{5}) is overlapping with {0}({6},{7},{8},{9},{10}). Please make shure the timeinterval is only used once!", nameof(Track), track2.Position, track2.Artist, track2.Title, track2.Begin, track2.End, track1.Position, track1.Artist, track1.Title, track1.Begin, track1.End)));
            //Assert.IsTrue(validationResult.ValidationMessages?.Contains(String.Format("{0}({1},{2},{3},{4},{5}) is overlapping with {0}({6},{7},{8},{9},{10}). Please make shure the timeinterval is only used once!", nameof(Track), track2.Position, track2.Artist, track2.Title, track2.Begin, track2.End, track3.Position, track3.Artist, track3.Title, track3.Begin, track3.End)));
            //Assert.IsTrue(validationResult.ValidationMessages?.Contains(String.Format("{0}({1},{2},{3},{4},{5}) is overlapping with {0}({6},{7},{8},{9},{10}). Please make shure the timeinterval is only used once!", nameof(Track), track3.Position, track3.Artist, track3.Title, track3.Begin, track3.End, track2.Position, track2.Artist, track2.Title, track2.Begin, track2.End)));
