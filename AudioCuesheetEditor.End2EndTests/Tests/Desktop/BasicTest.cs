...
namespace AudioCuesheetEditor.End2EndTests.Tests.Desktop
{
  ...
  - tabpanel ""Export konfigurieren"":
    - text: ""Export ist derzeit nicht möglich: Künstler hat keinen Wert! Titel hat keinen Wert! Audiodateien hat ungültige Anzahl (0)! YouTube""
  ...
  - button ""Next"" [disabled]");
            ...
            await Expect(TestPage.Locator("#app")).ToMatchAriaSnapshotAsync(@"- listbox:
  - paragraph: Künstler
  - paragraph: Titel
...
- banner:
  - toolbar:
    - button ""Home"":
      - heading ""AudioCuesheetEditor"" [level=6]
    - group:
    ...
    - button ""More""
- tablist:
  - tab ""Detailansicht"" [selected]
  - tab ""Aufnahmeansicht""
  - tab ""Importansicht""
- tabpanel ""Detailansicht"":
  - heading ""Allgemeine Informationen"" [level=5]
  - textbox ""Cuesheet Künstler"":
    - /placeholder: Geben Sie hier den Künstler des Cuesheets ein
  - group ""Cuesheet Künstler""
  - text: Cuesheet Künstler
  - textbox ""Cuesheet Titel"":
    - /placeholder: Geben Sie hier den Titel des Cuesheets ein
  - group ""Cuesheet Titel""
  - text: Cuesheet Titel
  - group:
    - textbox ""CD Textdatei"": Keine Datei ausgewählt
    - group ""CD Textdatei""
    - text: CD Textdatei
    - button ""Durchsuchen""
    - button ""Clear file"" [disabled]
    - button ""More""
  - textbox ""Katalognummer"":
    - /placeholder: Geben Sie hier die Katalognummer des Cuesheets ein
  - group ""Katalognummer""
  - text: Katalognummer
  - heading ""Dateien"" [level=5]
  - button ""Datei hinzufügen""
  - group:
    - button ""Ausgewählte Dateien nach oben bewegen"" [disabled]
    - button ""Ausgewählte Dateien nach unten bewegen"" [disabled]
  - group:
    - button ""Ausgewählte Dateien löschen"" [disabled]
    - button ""Alle Dateien löschen"" [disabled]
  - heading ""Validierungsfehler"" [level=4]
  - paragraph: Audiodateien hat ungültige Anzahl (0)!
  - heading ""Wiedergabe"" [level=5]
  - group:
    - paragraph: ""--:--:--""
    - slider ""Playback slider"" [disabled]: ""0""
    - paragraph: ""--:--:--""
  - group:
    - button ""Play"" [disabled]
    - group:
      - button ""Zum vorherigen Titel springen"" [disabled]
      - button ""Die aktuelle Wiedergabe stoppen"" [disabled]
      - button ""Zum nächsten Titel springen"" [disabled]");
